...
heroImage: "https://cdn.siliconwit.com/blog/remote-monitoring/cnc-machine-tool.png"
---
...
![Panel (a): calendar time of 72.3 hours against spindle time of 63.7 hours, the difference of 8.6 hours shown as a red block, giving utilisation of 88.1 per cent. Panel (b): a 40 hour quote multiplied by 88.1 per cent delivering 35.2 hours, leaving a 4.8 hour shortfall on every 40 hours quoted](./images/utilisation-arithmetic.svg)

Take the ordinary version of this mistake. You quote a job at 40 machine hours, priced on the assumption that the machine delivers 40 hours of cutting in 40 hours of calendar time. At 88.1% it delivers 35.2. You are 4.8 hours short, which either comes out of margin as overtime or comes out of the delivery date.
...
Power draw, load, bearing temperature and vibration run across the rest of the plant, and what differs is the reason each machine is watched. A [production line drive motor](https://siliconwit.io/d/production-line-motor) is instrumented for the vibration trend and almost nothing else. A [plant air compressor](https://siliconwit.io/d/plant-air-compressor) is there because compressed air costs more than lighting and heating together, and its owner needed somewhere to prove it. An [injection moulding machine](https://siliconwit.io/d/injection-moulding-machine) counts cycles and short stops for the same quoting reason this machine does, because quoted capacity and actual capacity have never been the same number.

Two more are worth opening for the failures behind them. A [steam boiler feed pump](https://siliconwit.io/d/steam-boiler-feed-pump) threw a bearing and took the boiler with it, and a [materials test rig](https://siliconwit.io/d/materials-test-rig) once stopped on a Friday night and was not found until Monday, which is the same lesson this post makes about short stoppages, scaled up to a whole weekend.
