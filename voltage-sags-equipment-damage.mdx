---
title: 'Counting the Wrong Events: 1,148 Sags and 63 Outages'
description: 'The outage log on this building says 63 events in ten weeks. The voltage record says 1,148. The difference is the events that never reached zero, which is also where the equipment damage comes from.'
contributors: "sam-macharia"
pubDate: 2026-06-25
tags: ["energy", "remote-monitoring", "iot", "power-quality", "voltage-sags", "predictive-maintenance", "electrical"]
excerpt: "Everybody counts outages, because an outage announces itself. The lights go, the generator starts, somebody writes it down. This installation logged 63 of them in ten weeks. Over the same ten weeks it also recorded 1,148 voltage sags, none of which appear in any outage log, and it is the sags that explain why the equipment kept failing."
...
$$\frac{1{,}148\ \text{sag events}}{63\ \text{outages}} = 18.2\ \text{sags for every outage}$$
...
$$\frac{1{,}308}{10{,}354} = 12.6\%\ \text{of the time}$$
