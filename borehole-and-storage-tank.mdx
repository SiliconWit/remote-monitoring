...
The fourth is not square. Look at Sunday morning. Current comes up to **4.8 A against a rated 8.9 A**, sits low, climbs slowly through the 5s and into the 6s, and only then makes it up to the 9.4 A the other three cycles reached from the start. That shoulder on the leading edge is about forty five minutes long.
...
<LinkButton href="https://siliconwit.io/d/borehole-and-storage-tank" variant="primary">Open this device</LinkButton>
