...
excerpt: "The reading you most want from a gas detector is zero, which creates the strangest problem in monitoring: the output you are hoping for is indistinguishable from total failure. Over ten weeks this detector reported zero in 2,270 of 2,286 windows. This post is about the second channel that tells you those zeros mean something."
...
$$\frac{2{,}270\ \text{windows reading exactly } 0}{2{,}286\ \text{windows}} = 99.3\%$$
