...
description: 'A building lost mains thirty times in a month for a total of 204 minutes, and its UPS battery never fully recovered between them. This reads both charts and what 98% availability actually means.'
contributors: "sam-macharia"
pubDate: 2026-09-16
tags: ["smart-buildings", "remote-monitoring", "iot", "power-quality", "ups", "facilities", "tenants"]
excerpt: "Ninety eight per cent availability sounds like a pass. It is three and a half hours of darkness a month, delivered in thirty separate interruptions, each one short enough that nobody wrote it down and long enough to drop every server in the building. This post reads a month of a monitored building supply."
...
The readings underneath tell a larger story. Summed across the month, this supply spent **1,082 minutes without mains**, which is just over **18 hours**, and works out at **97.5% availability**. The alert log accounts for less than a fifth of that. This post is partly about the gap between those two numbers.
...
Frequency and duration are different quantities and they do different damage. A supply that fails once for three hours is a supply problem. A supply that fails thirty times for six minutes is a **reliability** problem, and the two want opposite responses: the first wants a generator, the second wants ride-through.

This is why the log matters more than the summary. A monthly availability figure would have shown this building as healthy. The list of thirty timestamps shows what is actually happening.
...
<LinkButton href="https://siliconwit.io/d/building-power-monitoring" variant="primary">Open this device</LinkButton>
